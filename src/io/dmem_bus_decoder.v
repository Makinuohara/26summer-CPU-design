module dmem_bus_decoder (
    ...
    wire hit_perf = dmem_addr >= 32'h80000038 && dmem_addr <= 32'h8000003f;
    wire hit_intc = dmem_addr >= 32'h81000000 && dmem_addr <= 32'h81200007;
    wire miss = !(hit_mem || hit_ps2 || hit_sw || hit_led || hit_seg || hit_btn || hit_perf || hit_intc);
    ...
    assign perf_cs = dmem_req && hit_perf;
